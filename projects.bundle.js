...
const dispToDo = () => {
    ...
    const displayTask = (newTask) => {
        if(nodeList.length === 0 || newTask.project === undefined) _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.toDoPg);
        ...
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoPg.appendChild(toDoDiv);
...
const toggleModal = () => {
    ...
    _config_js__WEBPACK_IMPORTED_MODULE_0__.modal.classList.add('visible');
...
const subscriptions = (() => {
    ...
    ps.subscribe('disp-to-do', dispToDo().displayTask);
...
const taskClick = (e) => {
    const subtaskChosen = nodeList.filter(node => node.task === e.target.children[1].innerHTML);
...
const displayProjects = (projects) => {
    ...
    const proj = arr[index][0].project;
    console.log(arr[0][0].project, proj)

    if(arr.length === 0 || proj === arr[0][0].project) {
    ...
    dispProject.innerHTML = `<span class="proj-disp">Project:</span> ${proj}`;
...
// const clearSubtaskDisplay = () => subtaskPage.removeChild(subtaskPage.firstChild);
