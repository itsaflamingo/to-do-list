...
/* harmony import */ var _week_pg_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./week-pg.js */ "./src/week-pg.js");
/* harmony import */ var _subtasks_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subtasks.js */ "./src/subtasks.js");
...
//factory function to create to-do nodes
const pubSub = () => {
...
const dispCalendar = () => {
    ...
    _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.calendarPg);

}
const dispWeekTasks = (week) => {

    if(nodeList.length === 0 || _config_js__WEBPACK_IMPORTED_MODULE_0__.weekPg.childElementCount >= week.length) {
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.weekPg);
        return;
    }
    ...
    week.forEach(node => {
        ...
        _config_js__WEBPACK_IMPORTED_MODULE_0__.weekPg.appendChild(toDoDiv);
    });
...
const dispToDo = (newTask) => {
    ...
    if(nodeList.length === 0 || newTask.project === undefined) {
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.toDoPg);
        return;
    };
        ...
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoPg.appendChild(toDoCheck);
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.toDoPg);

}
ps.subscribe('nodeAdded', addNode());

const formRetrieve = () => {
    
    removeVisibility(_config_js__WEBPACK_IMPORTED_MODULE_0__.modal);
    ...
    _config_js__WEBPACK_IMPORTED_MODULE_0__.form.reset();
}
const toggleModal = () => _config_js__WEBPACK_IMPORTED_MODULE_0__.modal.classList.add('visible');
...
const subscriptions = (() => {
    ...
    ps.subscribe('disp-calendar', dispCalendar);
    ps.subscribe('disp-week', dispWeekTasks);
    ps.subscribe('filter-week', _week_pg_js__WEBPACK_IMPORTED_MODULE_2__.filterForWeek);
    ps.subscribe('disp-to-do', dispToDo);
    ps.subscribe('disp-subtask', _subtasks_js__WEBPACK_IMPORTED_MODULE_3__.createSubtaskLayout);
    ps.subscribe('delete-task', deleteElement().deleteNode);
})();

console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), 'MM/dd/yyyy'));

//Must click on parent and then target child, because event listener on child won't execute.
const toDoListPg = document.querySelector('#to-do-list');
const addSubtask = document.querySelector('#add-subtask');

submit.addEventListener('click', () => formRetrieve());
_config_js__WEBPACK_IMPORTED_MODULE_0__.addNewTaskBtn.addEventListener('click', () => toggleModal());
toDoListPg.addEventListener('click', (e) => taskClick(e));
// addSubtask.addEventListener('click', () => newSubtask());
...
const taskClick = (e) => {
    ...
    ps.publish('disp-subtask', subtaskChosen[0]);
...
const projectBtn = document.querySelector('#new-proj-btn');
_config_js__WEBPACK_IMPORTED_MODULE_0__.newProjBtn.addEventListener('click', () => newProject(_index_js__WEBPACK_IMPORTED_MODULE_1__.customProjects));

const displayProjects = (projects) => {

    if(_index_js__WEBPACK_IMPORTED_MODULE_1__.nodeList.length === 0 || _config_js__WEBPACK_IMPORTED_MODULE_0__.projectsPg.childElementCount >= Object.keys(projects).length) {
        _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.projectsPg);
        return;
    }
    ...
    arr.forEach(node => {
        ...
        dispProject.innerHTML = `<span class="proj-disp">Project:</span> ${node}`;

        _config_js__WEBPACK_IMPORTED_MODULE_0__.projectsPg.appendChild(projNode);
        _config_js__WEBPACK_IMPORTED_MODULE_0__.projectsPg.appendChild(dispProject);
    })
    _config_js__WEBPACK_IMPORTED_MODULE_0__.toDoList.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.projectsPg);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createSubtaskLayout": () => (/* binding */ createSubtaskLayout),
/* harmony export */   "newSubtask": () => (/* binding */ newSubtask)
/* harmony export */ });
/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config.js */ "./src/config.js");
...
const createSubtaskLayout = (task) => {

    if(_config_js__WEBPACK_IMPORTED_MODULE_0__.subtaskPg.hasChildNodes() === true) clearSubtaskDisplay();
    ...
    _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.appendChild(title);

    datePrioDiv.appendChild(dueDate);
    datePrioDiv.appendChild(priority);
    _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.appendChild(datePrioDiv);
    subtaskList.appendChild(subtasks);

    _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.appendChild(subtaskList);
    _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.appendChild(newSubtaskBtn);
    _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.appendChild(notes);

    subtaskPage.appendChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv);
} 

const clearSubtaskDisplay = () => {
    while (_config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.firstChild) {
        _config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.removeChild(_config_js__WEBPACK_IMPORTED_MODULE_0__.subTasksDiv.firstChild);
    }
};
